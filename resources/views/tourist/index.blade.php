    ...
    <section class="bg-dark text-light p-5 p-lg-0 pt-lg-5 text-start text-sm-start">
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-start ">
                ...
                <img class="img-fluid w-50 d-none d-sm-block" src="{{asset('culture/img_header.png')}}" alt=""
                    style="height: 300px" />
            </div>
        </div>
    </section>
    <section>
        <nav class="navbar bg-light">
            <div class="container-fluid">
                ...
                <form class="d-flex" role="search" action="/tourist">
                        ...
                        <div class="col-md-3 col-sm-6 col-lg-4 col-8 g-4">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex justify-content-center align-items-center">
                                    <a href=" /tourist/{{ $listing->id }} ">Learn
                                        more</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="/booking" class=" bg-success rounded px-2 py-1">Book Now</a>
                                </div>
