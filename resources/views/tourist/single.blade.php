...
@section('content')
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="#" class="nav-link">Tourist Sites</a>
            </li>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tourist Site</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
 ...
 <img src="{{$listings->logo ? asset('storage/'. $listings->logo ) : asset('/images/prod-1.jpg')}}"
                            ...
                            <div class="product-image-thumb"><img src="{{$listings->slider_two ? asset('storage/'. $listings->slider_two ) : asset('/images/prod-1.jpg')}}"
                                    alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="{{$listings->slider_three ? asset('storage/'. $listings->slider_three ) : asset('/images/prod-2.jpg')}}"
                                    alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="{{$listings->slider_four ? asset('storage/'. $listings->slider_four ) : asset('/images/prod-1.jpg')}}"
                                    alt="Product Image"></div>

                        </div>
                        <div class="col-12">
                            <img src="{{$listings->logo ? asset('storage/'. $listings->logo ) : asset('/images/prod-1.jpg')}}" class="product-image" alt="Product Image">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        ...
                        <hr>
                        <h4>Location of Tourist Site</h4>
                        ...
                        <div class="mt-4">
                            <div class="btn btn-primary btn-lg btn-flat">
                             <a href="/booking" class="text-dark"> <i class="fas fa-cart-plus fa-lg mr-2"></i>
                               Book Now</a>
                            </div>
